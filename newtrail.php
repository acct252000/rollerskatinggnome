...
//pull current skates for filter query in top bar
...
<!-- list of skates that displays when value entered in search all skates field -->
...
<!-- Form to suggest a new trail to the gnome -->
...
<div id="form_detail" class="corners">
    <form id="trail_form" action="newtrail.php" data-bind="submit: submitNewTrail" method="POST">
        ...
        <br/>
        <input type="text" class="long_text" placeholder="Trail Name" data-bind="value: newTrailForm.name" id="name" autofocus>
        <br/>
        <label for="lat">Latitude:</label>
        <input type="text" class="input_location" data-bind="value: newTrailForm.lat" id="lat">
        <label for="lng">Longitude:</label>
        <input type="text" class="input_location" data-bind="value: newTrailForm.lng" id="long">
        <br>
        <!-- section only displays if looking up lat/lng by address -->
        <div id="googAddress" data-bind="if: showAForm()">
            <label for="formAddress">Address:</label>
            <br>
            <input type="text" class="long_text" data-bind="value: newTrailForm.formAddress" id="formAddress">
            <button data-bind="click: geoCodeInput">Go!</button>
        </div>
        <button data-bind="click: getUserLocation">Get Position from Current Location</button>
        <br/>
        <button data-bind="click: showAddressForm">Get Position from Address</button>
        <br/>
        <label for="parking_location">Parking Location:</label>
        <br/>
        <input type="textarea" data-bind="value: newTrailForm.parking_location" class="form_area" id="parking_location">
        <br />
        <label for="parking_cost">Cost to Park:</label>
        <br/>
        <input type="text" data-bind="value: newTrailForm.parking_cost" placeholder="$0.00" id="parking_cost">
        <br />
        <label for="skate_length">Trail Length (miles):</label>
        <br />
        <input type="text" data-bind="value: newTrailForm.skate_length" placeholder="0" id="skate_length">
        <br />
        <label for="info">Need to Know Information:</label>
        <br />
        <input type="textarea" data-bind="value: newTrailForm.info" rows="4" class="form_area" id="info">
        <br />
        <label for="group">Schedule Group Skates:</label>
        <br />
        <input type="textarea" data-bind="value: newTrailForm.group" rows="4" class="form_area" id="group">
        <br />
        <label for="web">Related Websites:</label>
        <br />
        <input type="textarea" data-bind="value: newTrailForm.web" rows="4" class="form_area" id="web">
        <br />
        <label for="email">Contact E-mail:</label>
        <br />
        <input type="text" data-bind="value: newTrailForm.email" placeholder="myemail@email.com" id="email" autocomplete="email">
        <br />
        <br />
        <input type="submit" value="Submit" name="submit" data-bind="click: submitNewTrail">
        <br />
